...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(
    ...
    b' \x03(\x0b\x32\x1d.perftools.profiles.ValueType\x12*\n\x06sample\x18\x02'
    b' \x03(\x0b\x32\x1a.perftools.profiles.Sample\x12,\n\x07mapping\x18\x03'
    b' \x03(\x0b\x32\x1b.perftools.profiles.Mapping\x12.\n\x08location\x18\x04'
    b' \x03(\x0b\x32\x1c.perftools.profiles.Location\x12.\n\x08\x66unction\x18\x05'
    b' \x03(\x0b\x32\x1c.perftools.profiles.Function\x12\x14\n\x0cstring_table\x18\x06'
    b' \x03(\t\x12\x13\n\x0b\x64rop_frames\x18\x07'
    b' \x01(\x03\x12\x13\n\x0bkeep_frames\x18\x08'
    b' \x01(\x03\x12\x12\n\ntime_nanos\x18\t'
    b' \x01(\x03\x12\x16\n\x0e\x64uration_nanos\x18\n'
    b' \x01(\x03\x12\x32\n\x0bperiod_type\x18\x0b'
    b' \x01(\x0b\x32\x1d.perftools.profiles.ValueType\x12\x0e\n\x06period\x18\x0c'
    b' \x01(\x03\x12\x0f\n\x07\x63omment\x18\r'
    b' \x03(\x03\x12\x1b\n\x13\x64\x65\x66\x61ult_sample_type\x18\x0e'
    b' \x01(\x03"\'\n\tValueType\x12\x0c\n\x04type\x18\x01'
    b' \x01(\x03\x12\x0c\n\x04unit\x18\x02'
    b' \x01(\x03"V\n\x06Sample\x12\x13\n\x0blocation_id\x18\x01'
    b' \x03(\x04\x12\r\n\x05value\x18\x02 \x03(\x03\x12(\n\x05label\x18\x03'
    b' \x03(\x0b\x32\x19.perftools.profiles.Label"@\n\x05Label\x12\x0b\n\x03key\x18\x01'
    b' \x01(\x03\x12\x0b\n\x03str\x18\x02 \x01(\x03\x12\x0b\n\x03num\x18\x03'
    b' \x01(\x03\x12\x10\n\x08num_unit\x18\x04'
    b' \x01(\x03"\xdd\x01\n\x07Mapping\x12\n\n\x02id\x18\x01'
    b' \x01(\x04\x12\x14\n\x0cmemory_start\x18\x02'
    b' \x01(\x04\x12\x14\n\x0cmemory_limit\x18\x03'
    b' \x01(\x04\x12\x13\n\x0b\x66ile_offset\x18\x04'
    b' \x01(\x04\x12\x10\n\x08\x66ilename\x18\x05'
    b' \x01(\x03\x12\x10\n\x08\x62uild_id\x18\x06'
    b' \x01(\x03\x12\x15\n\rhas_functions\x18\x07'
    b' \x01(\x08\x12\x15\n\rhas_filenames\x18\x08'
    b' \x01(\x08\x12\x18\n\x10has_line_numbers\x18\t'
    b' \x01(\x08\x12\x19\n\x11has_inline_frames\x18\n'
    b' \x01(\x08"v\n\x08Location\x12\n\n\x02id\x18\x01'
    b' \x01(\x04\x12\x12\n\nmapping_id\x18\x02'
    b' \x01(\x04\x12\x0f\n\x07\x61\x64\x64ress\x18\x03'
    b' \x01(\x04\x12&\n\x04line\x18\x04'
    b' \x03(\x0b\x32\x18.perftools.profiles.Line\x12\x11\n\tis_folded\x18\x05'
    b' \x01(\x08")\n\x04Line\x12\x13\n\x0b\x66unction_id\x18\x01'
    b' \x01(\x04\x12\x0c\n\x04line\x18\x02'
    b' \x01(\x03"_\n\x08\x46unction\x12\n\n\x02id\x18\x01'
    b' \x01(\x04\x12\x0c\n\x04name\x18\x02'
    b' \x01(\x03\x12\x13\n\x0bsystem_name\x18\x03'
